...
public class FreemarkerTest {
	...
	public void testFreemarkerFirst() throws Exception {
		...
		//设置模板所在的目录/taotao-item-web/src/main/resources/ftl
		configuration.setDirectoryForTemplateLoading(new File("G:/javaEE/day12/taotao-item-web/src/main/resources/ftl"));
		//设置模板字符集
...
//		Template template = configuration.getTemplate("hello.ftl");
		...
		data.put("mytest", 123);
		//设置模板输出的目录及输出的文件名
		FileWriter writer = new FileWriter(new File("G:/temp/freemarker/first22.html"));
		//生成文件
