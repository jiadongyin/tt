...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        ...
        <label for="toggle-checkboxes_up">全选
        </label></div>
          ...
          <div class="cart-total-2014">
              <div class="cart-button">
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="javascript:void(0)" clstag="clickcart|keycount|xincart|gotoOrderInfo" id="toSettlement" onclick="jiaoyan()">去结算<b></b></a>
...
function jiaoyan(){
	 var names = document.getElementsByName("checkItem");   
	 var checkedid = '';
     for(var i=0;i<names.length;i++){  
        if(names[i].checked){  
            checkedid = checkedid +":"+names[i].value;
        }
    }  
    location.href="http://localhost:8091/order/order-cart.html?checkedid="+checkedid;
}

//复选框全选和全不选
$(function(){
	$("#toggle-checkboxes_up").click(function(){
		$(":checkbox[name='checkItem']").prop("checked",this.checked);
	});
});
$(function(){
